...
EMAIL_SUBJECT = 'Reminder: Internship Commencement Details'
...
def send_internship_details_email(name, to_email, role):
    try:
        ...
        Hello {name},
        <br><br>
        This is a gentle reminder that the project-based internship for interns starting from <strong>September 2025</strong> is scheduled to start tomorrow, <strong>September 8th, 2025, at 10 AM</strong>. We are incredibly excited to have you on board!
        <br><br>
        A detailed schedule and Google Meet links will be shared with you soon in the official WhatsApp group.
        <br><br>
        To help us plan better and ensure a smooth onboarding process, it is essential that you join the correct WhatsApp group based on your internship start date as soon as possible:
        <br>
