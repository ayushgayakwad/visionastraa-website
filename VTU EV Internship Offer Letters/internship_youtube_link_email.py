...
SMTP_PORT = 465
EMAIL_SUBJECT = 'Internship: Live Session Links - Feb 5, 2026 | VisionAstraa EV Academy'
...
def send_email(sender_email, sender_password, name, to_email):
    try:
        ...
        <body style="font-family: Arial, sans-serif; color: #333333; line-height: 1.6;">
            ...
            <p>Please find below the schedule and joining links for the internship sessions scheduled for <strong>February 5, 2026</strong>.</p>
