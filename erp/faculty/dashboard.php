...
<head>
    ...
    <title>Faculty Dashboard - EV Academy ERP</title>
        ...
        <div class="container">
            <div class="header-content" style="display:flex;align-items:center;justify-content:space-between;">
                ...
                <nav class="nav-desktop">
                    ...
                    <a href="add_working_hours.php" class="nav-link">Add Working Hours</a>
        ...
        <section class="hero">
            <div class="container">
                <div class="hero-content" style="max-width: 600px; margin: 0 auto;">
                    <h1 class="hero-title" style="text-align:center; color:#3a4a6b;">Welcome, Faculty!</h1>
                    <div class="dashboard-actions">
                        <a href="add_working_hours.php" class="dashboard-action-btn">
