...
// Fetch existing feedback for today to prevent re-submission or show submitted feedback
...
$stmt_existing_feedback->execute([$student_id, $date]);
$existing_feedback = [];
...
<head>
    ...
    <title>Give Feedback - Student | EV Academy ERP</title>
