...
$username = "u707137586_VSA_Careers";
$password = "#uhj]AVg?s9D";
$dbname = "u707137586_VSA_Careers";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        $message = 'Dear ' . $row['first_name'] . ',<br><br>Thank you for applying for the role of '.$row['role'].'. We have received your details and will get back to you soon.<br><br>Best regards,<br>VisionAstraa Startup Academy';
