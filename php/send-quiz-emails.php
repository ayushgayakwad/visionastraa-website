    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <body>
            <div class="container">
                ...
                <p>Cut-off to qualify for next round is 95.</p>
                <br>
                <p>************************************************************************</p>
                <p><b>Your Journey in EV Industry doesnt have to stop here!</b></p>
                <p>We want to give you a second chance especially if you have a CGPA >7.0 in your B.Tech/M.Tech and still very interested to build a career in EV Industry. </p>
                <!-- 
