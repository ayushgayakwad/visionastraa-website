    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <body>
            <div class="container">
                ...
                <p>Our next batch starts from first week of November, reserve your seat today!</p>
                <a href="https://www.visionastraa.com/ev-application.html" style="padding: 10px; background-color: #4CAF50; color: white; text-align: center; border-radius: 5px; width: 200px; text-decoration: none; display: inline-block; font-weight: bold; margin-top:8px;">Apply Now</a>
