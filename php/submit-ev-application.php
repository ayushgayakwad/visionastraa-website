...
$stmt = $conn->prepare("INSERT INTO applications 
    (first_name, last_name, email, phone, dob, state, location, college, degree, specialization, graduation_year, cgpa, resume, resume_filename, goals, referral_code, term, enrolled, confirmationEmailSent) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'false', 'false')");

$stmt->bind_param("sssssssssssssssss", $first_name, $last_name, $email, $phone, $dob, $state, $location, $college, $degree, $specialization, $graduation_year, $cgpa, $resume, $resume_filename, $goals, $referral_code, $term);
