...
$tableCreationQuery = "CREATE TABLE IF NOT EXISTS enrolls (
...
$checkQuery = $conn->prepare("SELECT id FROM enrolls WHERE email = ? OR phone = ?");
...
$stmt = $conn->prepare("INSERT INTO enrolls 
