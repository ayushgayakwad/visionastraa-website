...
# Updated Campaign ID
CAMPAIGN_ID = "ev_marketing_campaign_4_2_december_2025"

EMAIL_SUBJECT = "Tamil Nadu Talent Making Strong Moves in the EV & Automotive Industry"
...
<head>
    ...
    <title>Tamil Nadu Talent Making Strong Moves in the EV & Automotive Industry</title>
    <style>
        body {{
...
<body>
    <div class="container">
        ...
        <h1>Tamil Nadu Talent Making Strong Moves in the EV & Automotive Industry</h1>

        <p>Dear {first_name},</p>

        <p>
            Students from Tamil Nadu showing outstanding capabilities and getting placed Electric Vehicle companies.
        </p>
        ...
        <h3>🎓 Student Placements – Tamil Nadu</h3>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td width="50%" valign="top" class="student-col" style="padding-right: 5px; padding-bottom: 10px;">
                    <div class="student-card">
                        ...
                        <span class="student-detail">University College of Engineering, Bitcampus Tiruchirappalli</span>
            ...
            <tr>
                ...
                <td width="50%" valign="top" class="student-col" style="padding-left: 5px; padding-bottom: 10px;">
                    <div class="student-card">
                        <img src="https://visionastraa.com/images/hemant-3.jpg" alt="Hemanth V" class="student-img">
                        <span class="student-name">Hemanth V</span>
                        <span class="student-detail">B.Tech, ECE, 2025</span>
                        <span class="student-detail">Velammal Institute of Technology, Chennai</span>
...
def main():
    ...
    for tbl in tables:
        ...
        query = f"""
            ...
            AND state IN ('Kerala', 'Tamil Nadu', 'Andhra Pradesh', 'Telangana', 'Karnataka', 'Maharashtra')
